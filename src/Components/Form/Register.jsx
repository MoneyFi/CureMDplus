...
const Register = ({ handleAction }) => {
    ...
    return (
        ...
        <form onSubmit={(e) => e.preventDefault()} className='flex flex-col min-w-[250px]:full max-w-[460px] mt-40 justify-start items-center bg-white text-black rounded-2xl shadow-lg z-50'>
            ...
            <article className='w-full h-full py-4 px-10 flex flex-col flex-wrap justify-center items-left text-base text-roboto gap-1 bg-none'>
                ...
                <div className='flex flex-col justify-center items-left w-full'>
                    ...
                    <select name="gender" id="gender" className='w-full rounded border border-[#E0E0E0] px-2 py-1 focus:outline-secondary-blue font-sans text-black bg-white'>
                ...
                <div className='flex flex-col justify-center items-left w-full'>
                    <label htmlFor="birthday" className='text-varela text-secondary-blue'>Fecha de Nacimiento</label>
                    <input type="date" name="birthday" id="birthday" className='w-full rounded border border-[#E0E0E0] px-2 py-1 focus:outline-secondary-blue font-sans text-black placeholder:text-[#969696]' />
                </div>
                <div className='flex flex-col justify-center items-left w-full'>
