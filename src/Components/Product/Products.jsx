...
const Products = () => {
    ...
    return (
        <div style={style} className='w-screen min-h-screen flex flex-col justify-around gap-4 items-center text-xs font-sans pt-20 pb-8 md:pb-0 px-8 md:px-2' id='products'>
