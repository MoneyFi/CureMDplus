    ...
    const products = [
        {
            ...
            essential: 'Consultas médicas de atención primaria en CureMD con atención primaria en telemedicina:  , incluyendo asistencia psicológica (1 por mes. Tope $20.000)_Atención por urgencias (Incluye odontológicas)_Prevención anual mujer (Pap y colpo) hombres, (Antígeno Prostático)',
        ...
        {
            title: 'Salud Plus',
            essential:'Consultas médicas de atención primaria en CureMD con atención primaria en telemedicina:  , incluyendo asistencia psicológica (1 por mes. Tope $30.000)_Atención por urgencias (incluye odontológicas)_Prevención anual mujer (Pap y colpo) hombres, (Antígeno Prostático)',
        ...
        },
        {
            ...
            essential: 'Atención primaria en telemedicina:  , (1 consulta al mes. Tope $20.000)._Asistencia convalecencia: Servicio de acompañante en establecimiento médico, Servicio de acompañante en domicilio, Bonificación de acompañante en Domicilio especial, Asesor Previsional.',
