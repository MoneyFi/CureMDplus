...
const Faqs = () => {
    ...
    const faqs = [
        {
            title: "¿Qué es CureMD+?",
            content: "CureMD+ es una compañía de Telemedicina que comercializa un seguro de salud a traves de Federacíon Patronal. Nuestra misión es brindar a las personas la cobertura que necesitan para proteger su salud y bienestar sin tener que preocuparse por los altos costos."
        },
        {
